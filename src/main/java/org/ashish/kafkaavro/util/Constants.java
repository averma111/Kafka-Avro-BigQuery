...
public class Constants {
    ...
    public static final String JOB_INITIATION_TIME ="job_initiation_time";
    ...
    public static final String SPARK_STREAMING_BATCH_DURATION = "spark_streaming_batch_duration";
    public static final String SOURCE_KAFKA = "source_kafka";
